...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1338512,19078100)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1338512,19078100)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4185932,313217)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4185932,313217)
  and c.invalid_reason is null
...
WHERE YEAR(C.drug_exposure_start_date) - P.year_of_birth > 19
