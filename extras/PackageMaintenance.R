...
#
# This file is part of AnthraCardiotoxicityPrediction
#
...
OhdsiRTools::checkUsagePackage("AnthraCardiotoxicityPrediction")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/AnthraCardiotoxicityPrediction.pdf")
shell("R CMD Rd2pdf ./ --output=extras/AnthraCardiotoxicityPrediction.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("AnthraCardiotoxicityPrediction")
