...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/AnthraCardiotoxicityPrediction/master/inst/doc/UsingSkeletonPackage.pdf)

For information on how to generate shiny apps using the R skeleton package see: [Creating shiny app for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/PatientLevelPrediction/testcode/inst/doc/CreatingShinyApp.pdf).  To combine multiple skeleton package results into a single shiny app [see populate multiple shiny app R code code](https://github.com/OHDSI/AnthraCardiotoxicityPrediction/blob/master/extras/populateMultipleShiny.R)

For information on adding custom covariates based on ATLAS cohorts see:  [Adding custom covariates using ATLAS cohorts](https://raw.githubusercontent.com/OHDSI/AnthraCardiotoxicityPrediction/master/inst/doc/AddingCohortCovariates.pdf).
...
```r
  library(AnthraCardiotoxicityPrediction)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./AnthraCardiotoxicityPredictionResults"
...
cohortTable <- 'AnthraCardiotoxicityPredictionCohort'
#=======================
...
```r
  ...
  devtools::install_github("ohdsi-studies/AnthraCardiotoxicityPrediction")
```
