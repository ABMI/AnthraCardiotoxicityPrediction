...
#'
#' @details
#' This function executes the AnthraCardiotoxicityPrediction Study.
#' 
...
execute <- function(connectionDetails,
  ...
  if(runDiagnostic){
    ...
    predictionAnalysisListFile <- system.file("settings",
                                              ...
                                              package = "AnthraCardiotoxicityPrediction")
  ...
  if(runAnalyses){
    ...
    if(!is.null(cohortVariableSetting)){
      ...
      pathToCustom <- system.file("settings", cohortVariableSetting, package = "AnthraCardiotoxicityPrediction")
